...
#define ggc_alloc_stub_list() ((struct stub_list *)(ggc_internal_alloc_stat (sizeof (struct stub_list) MEM_STAT_INFO)))
#define ggc_alloc_cleared_stub_list() ((struct stub_list *)(ggc_internal_cleared_alloc_stat (sizeof (struct stub_list) MEM_STAT_INFO)))
#define ggc_alloc_vec_stub_list(n) ((struct stub_list *)(ggc_internal_vec_alloc_stat (sizeof (struct stub_list), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_stub_list(n) ((struct stub_list *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct stub_list), n MEM_STAT_INFO)))
