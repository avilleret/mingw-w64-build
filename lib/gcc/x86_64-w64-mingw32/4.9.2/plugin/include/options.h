...
enum opt_code
{
  ...
  OPT_Wpedantic_ms_format = 312,             /* -Wpedantic-ms-format */
  ...
  OPT_fset_stack_executable = 876,           /* -fset-stack-executable */
  OPT_fshort_double = 877,                   /* -fshort-double */
  OPT_fshort_enums = 878,                    /* -fshort-enums */
  OPT_fshort_wchar = 879,                    /* -fshort-wchar */
  OPT_fshow_column = 880,                    /* -fshow-column */
  OPT_fshrink_wrap = 881,                    /* -fshrink-wrap */
  OPT_fsign_zero = 882,                      /* -fsign-zero */
  OPT_fsignaling_nans = 883,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 884,               /* -fsigned-bitfields */
  OPT_fsigned_char = 885,                    /* -fsigned-char */
  OPT_fsigned_zeros = 886,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 887,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 888,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 889,               /* -fsource-filename= */
  OPT_fsource_ = 890,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 891,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 892,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 893,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 894, */                 /* -fsquangle */
  OPT_fstack_arrays = 895,                   /* -fstack-arrays */
  /* OPT_fstack_check = 896, */              /* -fstack-check */
  OPT_fstack_check_ = 897,                   /* -fstack-check= */
  OPT_fstack_limit = 898,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 899,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 900,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 901,                /* -fstack-protector */
  OPT_fstack_protector_all = 902,            /* -fstack-protector-all */
  OPT_fstack_protector_strong = 903,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 904,                   /* -fstack-reuse= */
  OPT_fstack_usage = 905,                    /* -fstack-usage */
  OPT_fstats = 906,                          /* -fstats */
  OPT_fstore_check = 907,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 908, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 909,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 910,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 911,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 912, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 913,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 914,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 915,                    /* -fsyntax-only */
  OPT_ftabstop_ = 916,                       /* -ftabstop= */
  /* OPT_ftarget_help = 917, */              /* -ftarget-help */
  OPT_ftarget_ = 918,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 919,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 920, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 921,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 922,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 923, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 924,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 925,             /* -fthreadsafe-statics */
  OPT_ftime_report = 926,                    /* -ftime-report */
  OPT_ftls_model_ = 927,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 928,               /* -ftoplevel-reorder */
  OPT_ftracer = 929,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 930,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 931,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 932,                  /* -ftrapping-math */
  OPT_ftrapv = 933,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 934,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 935,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 936,                       /* -ftree-ccp */
  OPT_ftree_ch = 937,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 938,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 939,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 940,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 941,                /* -ftree-copyrename */
  OPT_ftree_cselim = 942,                    /* -ftree-cselim */
  OPT_ftree_dce = 943,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 944,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 945,                       /* -ftree-dse */
  OPT_ftree_forwprop = 946,                  /* -ftree-forwprop */
  OPT_ftree_fre = 947,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 948,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 949,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 950,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 951,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 952,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 953,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 954, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 955,             /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 956,            /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 957,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 958,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 959,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 960,                   /* -ftree-phiprop */
  OPT_ftree_pre = 961,                       /* -ftree-pre */
  OPT_ftree_pta = 962,                       /* -ftree-pta */
  OPT_ftree_reassoc = 963,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 964, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 965,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 966,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 967,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 968,                      /* -ftree-slsr */
  OPT_ftree_sra = 969,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 970, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 971, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 972,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 973,                /* -ftree-tail-merge */
  OPT_ftree_ter = 974,                       /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 975, */   /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 976,                 /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 977, */ /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 978,                       /* -ftree-vrp */
  OPT_funderscoring = 979,                   /* -funderscoring */
  OPT_funit_at_a_time = 980,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 981,               /* -funroll-all-loops */
  OPT_funroll_loops = 982,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 983,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 984,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 985,             /* -funsigned-bitfields */
  OPT_funsigned_char = 986,                  /* -funsigned-char */
  OPT_funswitch_loops = 987,                 /* -funswitch-loops */
  OPT_funwind_tables = 988,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 989,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 990,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 991,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 992,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 993,          /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 994,                     /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 995,                    /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 996,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 997,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 998,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 999,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1000,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1001,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1002, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1003,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1004,                   /* -fverbose-asm */
  /* OPT_fversion = 1005, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1006,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1007,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1008,                   /* -fvisibility= */
  OPT_fvpt = 1009,                           /* -fvpt */
  /* OPT_fvtable_gc = 1010, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1011, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1012,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1013,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1014,                     /* -fvtv-debug */
  OPT_fweak = 1015,                          /* -fweak */
  OPT_fweb = 1016,                           /* -fweb */
  /* OPT_fwhole_file = 1017, */              /* -fwhole-file */
  OPT_fwhole_program = 1018,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1019,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1020,             /* -fworking-directory */
  OPT_fwpa = 1021,                           /* -fwpa */
  OPT_fwpa_ = 1022,                          /* -fwpa= */
  OPT_fwrapv = 1023,                         /* -fwrapv */
  OPT_fwritable_relocated_rdata = 1024,      /* -fwritable-relocated-rdata */
  /* OPT_fxref = 1025, */                    /* -fxref */
  /* OPT_fzee = 1026, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1027,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1028,                     /* -fzero-link */
  OPT_g = 1029,                              /* -g */
  OPT_gant = 1030,                           /* -gant */
  OPT_gcoff = 1031,                          /* -gcoff */
  OPT_gdwarf = 1032,                         /* -gdwarf */
  OPT_gdwarf_ = 1033,                        /* -gdwarf- */
  OPT_gen_decls = 1034,                      /* -gen-decls */
  OPT_ggdb = 1035,                           /* -ggdb */
  OPT_ggnu_pubnames = 1036,                  /* -ggnu-pubnames */
  OPT_gnat = 1037,                           /* -gnat */
  OPT_gnatO = 1038,                          /* -gnatO */
  OPT_gno_pubnames = 1039,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1040,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1041,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1042,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1043,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1044,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1045,                   /* -gsplit-dwarf */
  OPT_gstabs = 1046,                         /* -gstabs */
  OPT_gstabs_ = 1047,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1048,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1049,                        /* -gtoggle */
  OPT_gvms = 1050,                           /* -gvms */
  OPT_gxcoff = 1051,                         /* -gxcoff */
  OPT_gxcoff_ = 1052,                        /* -gxcoff+ */
  OPT_h = 1053,                              /* -h */
  OPT_idirafter = 1054,                      /* -idirafter */
  OPT_imacros = 1055,                        /* -imacros */
  OPT_imultiarch = 1056,                     /* -imultiarch */
  OPT_imultilib = 1057,                      /* -imultilib */
  OPT_include = 1058,                        /* -include */
  OPT_iplugindir_ = 1059,                    /* -iplugindir= */
  OPT_iprefix = 1060,                        /* -iprefix */
  OPT_iquote = 1061,                         /* -iquote */
  OPT_isysroot = 1062,                       /* -isysroot */
  OPT_isystem = 1063,                        /* -isystem */
  OPT_iwithprefix = 1064,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1065,              /* -iwithprefixbefore */
  OPT_k8 = 1066,                             /* -k8 */
  OPT_l = 1067,                              /* -l */
  OPT_lang_asm = 1068,                       /* -lang-asm */
  OPT_m128bit_long_double = 1069,            /* -m128bit-long-double */
  OPT_m16 = 1070,                            /* -m16 */
  OPT_m32 = 1071,                            /* -m32 */
  OPT_m3dnow = 1072,                         /* -m3dnow */
  OPT_m3dnowa = 1073,                        /* -m3dnowa */
  OPT_m64 = 1074,                            /* -m64 */
  OPT_m80387 = 1075,                         /* -m80387 */
  OPT_m8bit_idiv = 1076,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1077,             /* -m96bit-long-double */
  OPT_mabi_ = 1078,                          /* -mabi= */
  OPT_mabm = 1079,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1080,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1081,                 /* -maddress-mode= */
  OPT_madx = 1082,                           /* -madx */
  OPT_maes = 1083,                           /* -maes */
  OPT_malign_double = 1084,                  /* -malign-double */
  OPT_malign_functions_ = 1085,              /* -malign-functions= */
  OPT_malign_jumps_ = 1086,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1087,                  /* -malign-loops= */
  OPT_malign_stringops = 1088,               /* -malign-stringops */
  OPT_march_ = 1089,                         /* -march= */
  OPT_masm_ = 1090,                          /* -masm= */
  OPT_mavx = 1091,                           /* -mavx */
  OPT_mavx2 = 1092,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1093,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1094,  /* -mavx256-split-unaligned-store */
  OPT_mavx512cd = 1095,                      /* -mavx512cd */
  OPT_mavx512er = 1096,                      /* -mavx512er */
  OPT_mavx512f = 1097,                       /* -mavx512f */
  OPT_mavx512pf = 1098,                      /* -mavx512pf */
  OPT_mbmi = 1099,                           /* -mbmi */
  OPT_mbmi2 = 1100,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1101,                  /* -mbranch-cost= */
  OPT_mcld = 1102,                           /* -mcld */
  OPT_mcmodel_ = 1103,                       /* -mcmodel= */
  OPT_mconsole = 1104,                       /* -mconsole */
  /* OPT_mcpu_ = 1105, */                    /* -mcpu= */
  OPT_mcrc32 = 1106,                         /* -mcrc32 */
  OPT_mcx16 = 1107,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1108,            /* -mdispatch-scheduler */
  OPT_mdll = 1109,                           /* -mdll */
  OPT_mdump_tune_features = 1110,            /* -mdump-tune-features */
  OPT_mf16c = 1111,                          /* -mf16c */
  OPT_mfancy_math_387 = 1112,                /* -mfancy-math-387 */
  OPT_mfentry = 1113,                        /* -mfentry */
  OPT_mfma = 1114,                           /* -mfma */
  OPT_mfma4 = 1115,                          /* -mfma4 */
  OPT_mforce_drap = 1116,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1117,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1118,                       /* -mfpmath= */
  OPT_mfsgsbase = 1119,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1120, */              /* -mfused-madd */
  OPT_mfxsr = 1121,                          /* -mfxsr */
  OPT_mhard_float = 1122,                    /* -mhard-float */
  OPT_mhle = 1123,                           /* -mhle */
  OPT_mieee_fp = 1124,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1125,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1126,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1127,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1128, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1129,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1130,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1131,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1132,                /* -mlong-double-80 */
  OPT_mlwp = 1133,                           /* -mlwp */
  OPT_mlzcnt = 1134,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1135,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1136,              /* -mmemset-strategy= */
  OPT_mmmx = 1137,                           /* -mmmx */
  OPT_mmovbe = 1138,                         /* -mmovbe */
  OPT_mms_bitfields = 1139,                  /* -mms-bitfields */
  ...
  OPT_mnop_fun_dllimport = 1146,             /* -mnop-fun-dllimport */
  OPT_momit_leaf_frame_pointer = 1147,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1148,                          /* -mpc32 */
  OPT_mpc64 = 1149,                          /* -mpc64 */
  OPT_mpc80 = 1150,                          /* -mpc80 */
  OPT_mpclmul = 1151,                        /* -mpclmul */
  OPT_mpe_aligned_commons = 1152,            /* -mpe-aligned-commons */
  OPT_mpopcnt = 1153,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1154,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1155,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1156,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1157,                        /* -mprfchw */
  OPT_mpush_args = 1158,                     /* -mpush-args */
  OPT_mrdrnd = 1159,                         /* -mrdrnd */
  OPT_mrdseed = 1160,                        /* -mrdseed */
  OPT_mrecip = 1161,                         /* -mrecip */
  OPT_mrecip_ = 1162,                        /* -mrecip= */
  OPT_mred_zone = 1163,                      /* -mred-zone */
  OPT_mregparm_ = 1164,                      /* -mregparm= */
  OPT_mrtd = 1165,                           /* -mrtd */
  OPT_mrtm = 1166,                           /* -mrtm */
  OPT_msahf = 1167,                          /* -msahf */
  OPT_msha = 1168,                           /* -msha */
  OPT_msoft_float = 1169,                    /* -msoft-float */
  OPT_msse = 1170,                           /* -msse */
  OPT_msse2 = 1171,                          /* -msse2 */
  OPT_msse2avx = 1172,                       /* -msse2avx */
  OPT_msse3 = 1173,                          /* -msse3 */
  OPT_msse4 = 1174,                          /* -msse4 */
  OPT_msse4_1 = 1175,                        /* -msse4.1 */
  OPT_msse4_2 = 1176,                        /* -msse4.2 */
  OPT_msse4a = 1177,                         /* -msse4a */
  /* OPT_msse5 = 1178, */                    /* -msse5 */
  OPT_msseregparm = 1179,                    /* -msseregparm */
  OPT_mssse3 = 1180,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1181,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1182,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1183,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1184,            /* -mstringop-strategy= */
  OPT_mtbm = 1185,                           /* -mtbm */
  OPT_mthreads = 1186,                       /* -mthreads */
  OPT_mtls_dialect_ = 1187,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1188,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1189,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1190,                         /* -mtune= */
  OPT_municode = 1191,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1192,          /* -muse-libstdc-wrappers */
  OPT_mveclibabi_ = 1193,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1194,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1195,                    /* -mvzeroupper */
  OPT_mwin32 = 1196,                         /* -mwin32 */
  OPT_mwindows = 1197,                       /* -mwindows */
  OPT_mx32 = 1198,                           /* -mx32 */
  OPT_mxop = 1199,                           /* -mxop */
  OPT_mxsave = 1200,                         /* -mxsave */
  OPT_mxsaveopt = 1201,                      /* -mxsaveopt */
  OPT_n = 1202,                              /* -n */
  OPT_no_canonical_prefixes = 1203,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1204,              /* -no-integrated-cpp */
  OPT_no_pthread = 1205,                     /* -no-pthread */
  ...
  OPT_std_c__98 = 1259,                      /* -std=c++98 */
  OPT_std_c11 = 1260,                        /* -std=c11 */
  /* OPT_std_c1x = 1261, */                  /* -std=c1x */
  /* OPT_std_c89 = 1262, */                  /* -std=c89 */
  OPT_std_c90 = 1263,                        /* -std=c90 */
  OPT_std_c99 = 1264,                        /* -std=c99 */
  /* OPT_std_c9x = 1265, */                  /* -std=c9x */
  OPT_std_f2003 = 1266,                      /* -std=f2003 */
  OPT_std_f2008 = 1267,                      /* -std=f2008 */
  OPT_std_f2008ts = 1268,                    /* -std=f2008ts */
  OPT_std_f95 = 1269,                        /* -std=f95 */
  OPT_std_gnu = 1270,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1271, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1272, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1273,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1274, */              /* -std=gnu++14 */
  OPT_std_gnu__1y = 1275,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1276,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1277,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1278, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1279, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1280,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1281,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1282, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1283, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1284,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1285, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1286, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1287, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1288,                     /* -std=legacy */
  OPT_symbolic = 1289,                       /* -symbolic */
  OPT_t = 1290,                              /* -t */
  OPT_time = 1291,                           /* -time */
  OPT_time_ = 1292,                          /* -time= */
  OPT_traditional = 1293,                    /* -traditional */
  OPT_traditional_cpp = 1294,                /* -traditional-cpp */
  OPT_trigraphs = 1295,                      /* -trigraphs */
  OPT_u = 1296,                              /* -u */
  OPT_undef = 1297,                          /* -undef */
  OPT_v = 1298,                              /* -v */
  OPT_version = 1299,                        /* -version */
  OPT_w = 1300,                              /* -w */
  OPT_wrapper = 1301,                        /* -wrapper */
  OPT_x = 1302,                              /* -x */
  OPT_z = 1303,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
